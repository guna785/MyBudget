...
namespace MyBudget.API.Controllers.Identity
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            MyBudget.Shared.Wrapper.Result<List<MyBudget.Application.Responses.Identity.UserResponse>> users = await _userService.GetAllAsync();
            return Ok(users);
        }
        ...
        {
            MyBudget.Shared.Wrapper.IResult<MyBudget.Application.Responses.Identity.UserResponse> user = await _userService.GetAsync(id);
            return Ok(user);
        }
        ...
        {
            MyBudget.Shared.Wrapper.IResult<MyBudget.Application.Responses.Identity.UserRolesResponse> userRoles = await _userService.GetRolesAsync(id);
            return Ok(userRoles);
        }
        ...
        {
            string data = await _userService.ExportToExcelAsync(searchString);
            return Ok(data);
        }
    }
}
