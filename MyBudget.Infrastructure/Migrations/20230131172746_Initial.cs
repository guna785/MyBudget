        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverDraft = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssetValue = table.Column<double>(type: "double", nullable: false),
                    AssetDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(128)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(128)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    DebtName = table.Column<string>(type: "longtext", nullable: false),
                    DebtAmount = table.Column<double>(type: "double", nullable: false),
                    DebtDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Intrest = table.Column<double>(type: "double", nullable: true),
                    Duration = table.Column<int>(type: "int", nullable: true),
                    DebtAmountWithIntrest = table.Column<double>(type: "double", nullable: false),
                    IntrestType = table.Column<byte>(type: "tinyint unsigned", nullable: false),
                    IsEMI = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EMIAmount = table.Column<double>(type: "double", nullable: false),
                    NoEMIs = table.Column<int>(type: "int", nullable: false),
                    EMIDate = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Salutaion = table.Column<byte>(type: "tinyint unsigned", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    WishName = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModeComments = table.Column<string>(type: "longtext", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(128)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(128)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DebtTransactions_Debts_DebtId",
                        column: x => x.DebtId,
                        principalTable: "Debts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DebtTransactions_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DebtTransactions_DebtId",
                table: "DebtTransactions",
                column: "DebtId");

            migrationBuilder.CreateIndex(
                name: "IX_DebtTransactions_TransactionId",
                table: "DebtTransactions",
